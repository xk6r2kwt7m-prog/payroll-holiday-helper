...
export function homeScreen(s) {
  ...
  <div class="metrics">${metric('NEEDS A DECISION', '4', 'Across your workspace', 'accent')}${metric('JOINING', '1', 'Awaiting manager checks')}${metric('ROTA', '1', 'Shift with a conflict')}${metric('PAYROLL', 'Review', 'Never approve with a blocker')}</div>
