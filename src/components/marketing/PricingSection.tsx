    ...
    <div className={className}>
      <div className="rounded-xl border border-primary/20 bg-card p-6 sm:p-8 max-w-2xl mx-auto text-center space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Button className="gradient-primary w-full sm:w-auto" size="lg" onClick={onBookDemo}>Book a demo</Button>
          <Button variant="outline" className="w-full sm:w-auto" size="lg" onClick={onSeePlatform}>See the platform</Button>
        </div>
      </div>
    </div>
  );
