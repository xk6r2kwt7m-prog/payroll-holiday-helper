  ...
  return (
    <div className={className}>
      <div className="rounded-xl border border-border bg-card p-6 sm:p-8 max-w-2xl mx-auto text-center space-y-5">
        <h3 className="text-base sm:text-lg font-bold text-foreground leading-snug max-w-lg mx-auto">
          Better control is not optional in hospitality. It is how you protect margin, standards and management time.
        </h3>
        <p className="text-sm text-muted-foreground leading-relaxed max-w-md mx-auto">
          When staffing, training, compliance and follow-through are disconnected, avoidable problems build quietly. UGLŌ is built for operators who need tighter workforce control and stronger day-to-day execution.
        </p>
