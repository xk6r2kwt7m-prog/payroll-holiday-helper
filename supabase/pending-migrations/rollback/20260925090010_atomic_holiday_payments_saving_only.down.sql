-- ROLLBACK for 20260925090010_atomic_holiday_payments_saving_only (review only; not applied). sync_payroll_period_totals below is re-stated verbatim; H1 never changed it.
